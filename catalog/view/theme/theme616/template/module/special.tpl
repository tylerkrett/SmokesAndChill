		...
		<div class="product-layout">
			...
			<div>
				...
				<div class="quick_info">
							...
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="cart-button">
										<button class="btn btn-add" type="button"  data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i></button>
					...
					<a class="quickview" data-rel="details" href="#quickview_specials_<?php echo $t; ?>">
                    	<span class="hidden-xs hidden-sm hidden-md"><?php echo $button_details; ?></span>
                    	<i class="fa  fa-eye"></i> 
                	</a>
