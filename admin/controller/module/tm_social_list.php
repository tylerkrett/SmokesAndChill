...
class ControllerModuleTmSocialList extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/tm_social_list', 'token=' . $this->session->data['token'], true)
		);

        $data['action'] = $this->url->link('module/tm_social_list', 'token=' . $this->session->data['token'], true);
